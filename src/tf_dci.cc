...
class DCIKNNOp : public OpKernel {
    private:
        int dim;
    ...
    explicit DCIKNNOp(OpKernelConstruction* context) : OpKernel(context) {
...
REGISTER_KERNEL_BUILDER(Name("DciKnn").Device(DEVICE_CPU), DCIKNNOp);
